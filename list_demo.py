def main ():
    # create a list of strings, intergers, and differing values
    ...
    print("Get values at specific indices in a list\n----------------------------------------")
    ...
    for current_value in list_of_integers:
        #if current_value > max_value, set max value to current value
        if current_value < max_value:
            max_value = current_value
    #after the loop is done, print the largest value 
    print(f"\nList of integers: {list_of_integers}")
    print(f"smallest value in list: {max_value}")
